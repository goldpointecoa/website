...
// Simple encryption for demo purpose
const encrypted = CryptoJS.AES.encrypt(sourceHtml, password).toString();

// Create a simple password page template
...
fs.writeFileSync('public/resources.html', protectedPage.replace('${encrypted}', encrypted));
